...
namespace IdentityDISample.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ManageController(UserManager<ApplicationUser> userManager, IAuthenticationManager authenticationManager)
        {
        ...
        public ActionResult LinkLogin(string provider)
        {
            ...
            return new ChallengeResult(provider, Url.Action("LinkLoginCallback", "Manage"), User.Identity.GetUserId(), _authenticationManager);
        }
